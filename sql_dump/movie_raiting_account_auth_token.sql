...
--
-- Table structure for table `account_auth_token`
--

DROP TABLE IF EXISTS `account_auth_token`;
...
CREATE TABLE `account_auth_token` (
  ...
  CONSTRAINT `fk_account_for_auth_id` FOREIGN KEY (`fk_account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-06-22 17:38:18
