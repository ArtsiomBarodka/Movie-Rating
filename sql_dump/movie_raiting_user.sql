...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fk_account_id_UNIQUE` (`fk_account_id`),
  UNIQUE KEY `uid_UNIQUE` (`uid`),
  CONSTRAINT `fk_account_id` FOREIGN KEY (`fk_account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
